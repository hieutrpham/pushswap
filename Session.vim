...
silent! normal! zE
let &fdl = &fdl
let s:l = 80 - ((28 * winheight(0) + 23) / 46)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 64 - ((45 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 64
...
silent! normal! zE
let &fdl = &fdl
let s:l = 74 - ((10 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 74
...
silent! normal! zE
let &fdl = &fdl
let s:l = 53 - ((50 * winheight(0) + 30) / 61)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 53
...
silent! normal! zE
let &fdl = &fdl
let s:l = 42 - ((7 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 42
