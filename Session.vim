...
exe 'vert 1resize ' . ((&columns * 117 + 120) / 240)
exe '2resize ' . ((&lines * 17 + 32) / 65)
exe 'vert 2resize ' . ((&columns * 117 + 120) / 240)
exe 'vert 3resize ' . ((&columns * 122 + 120) / 240)
argglobal
balt TODO.md
...
silent! normal! zE
let &fdl = &fdl
let s:l = 65 - ((32 * winheight(0) + 22) / 44)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 78 - ((12 * winheight(0) + 8) / 17)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 78
...
silent! normal! zE
let &fdl = &fdl
let s:l = 53 - ((31 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 53
...
silent! normal! zE
let &fdl = &fdl
let s:l = 75 - ((51 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 75
...
silent! normal! zE
let &fdl = &fdl
let s:l = 53 - ((52 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 53
...
silent! normal! zE
let &fdl = &fdl
let s:l = 59 - ((10 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 59
